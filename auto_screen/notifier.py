...
FLAG_TEXT = {
    ...
    "short_track_recent_activation": "长期账号的有效活跃轨迹偏短，近期活跃占比偏高",
    "short_track_recent_activation_45": "有效活跃轨迹偏短且近期活跃集中，分数已封顶",
    "single_day_move_extreme_52": "单日收益波动过大，分数已封顶",
    "single_day_move_high_60": "单日收益波动偏大，分数已封顶",
    "sports_concentration_unstable_39": "体育盘占比过高且活跃/波动结构不稳，已判定为不适合跟单",
    "sports_concentration_watch_45": "体育盘占比较高且稳定性不足，分数已封顶",
