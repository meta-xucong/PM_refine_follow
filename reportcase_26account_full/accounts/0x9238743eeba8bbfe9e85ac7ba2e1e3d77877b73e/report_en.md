...
- final_score (decision basis): `50.360000`
- raw_score: `32.480000`
...
- Observed 2920 trades across 31 active trading days in the analysis window.
...
- Hard blacklist themes to avoid: russia, march, capture, april, iran, enter.
- Soft blacklist themes requiring stricter triggers: win, military, united, manchester, barcelona, league.
