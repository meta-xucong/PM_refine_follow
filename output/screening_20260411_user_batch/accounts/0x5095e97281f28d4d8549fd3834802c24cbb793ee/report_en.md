...
- Source local name: `account_41`

## 1. Executive Conclusion
Calibrated decision score is 63.65 (anchor-referenced), decision: selective_copying_only. Primary sector exposure: entertainment. Strengths: contained multi-market weighted risk, low non-copyable token-fast ratio. Key risks: dual-side condition buying. Hard blacklist themes: box, office, weekend, opening, greater. Soft blacklist themes: reminders, him, here, ready, not. Risk gate is active, so broad-copy mode is disabled. PnL curve tag: long_and_recent_weak. This account is best used in selective-copy mode with strict event filters and blacklist constraints.

## 2. Decision Snapshot
- decision: `selective_copying_only`
- final_score (decision basis): `63.650000`
- raw_score: `52.920000`
...
- Observed 911 trades across 25 active trading days in the analysis window.
...
- Hard blacklist themes to avoid: box, office, weekend, opening, greater, between.
- Soft blacklist themes requiring stricter triggers: reminders, him, here, ready, not, come.
