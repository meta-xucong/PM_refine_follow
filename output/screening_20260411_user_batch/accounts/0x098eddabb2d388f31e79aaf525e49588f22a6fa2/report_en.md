...
- Display name: `Youthful-Target`
- Account address: `0x098eddabb2d388f31e79aaf525e49588f22a6fa2`
- Source pseudonym: `Youthful-Target`
- Source profile name: `FreeCityIndividual`
- Source local name: `account_17`

## 1. Executive Conclusion
Calibrated decision score is 49.80 (anchor-referenced), decision: selective_copying_only. Primary sector exposure: sports, us_politics, macro. Strengths: deployable event breadth, contained multi-market weighted risk, low non-copyable token-fast ratio. Key risks: nested concurrent-ladder risk. Hard blacklist themes: fed, win, michigan, tournament, league. Soft blacklist themes: presidential, nomination, republican, tucker, carlson. Whitelist themes: seoul, chong, mayoral, won-oh, primary. PnL curve tag: long_mid_short_strong. This account is best used in selective-copy mode with strict event filters and blacklist constraints.

## 2. Decision Snapshot
- decision: `selective_copying_only`
- final_score (decision basis): `49.800000`
- raw_score: `67.620000`
...
- Observed 852 trades across 30 active trading days in the analysis window.
...
- Operational whitelist themes: seoul, chong, mayoral, won-oh, primary, march.

## 5. Copy-Trading Risks
- High nested concurrent-ladder ratio, implying heavier structure management.
- Hard blacklist themes to avoid: fed, win, michigan, tournament, league, premier.
- Soft blacklist themes requiring stricter triggers: presidential, nomination, republican, tucker, carlson, democratic.
