...
def render(template: str, data: dict, lang: str) -> str:
    ...
    mapping = {
        ...
        "score_version": data.get("score_version") or "v2_2",
        "legacy_v2_score": fmt_num(data.get("legacy_v2_score")),
        "discovery_score": fmt_num(data.get("discovery_score")),
        "data_quality_score": fmt_num(data.get("data_quality_score")),
        "pnl_quality_score": fmt_num(data.get("pnl_quality_score")),
        "copy_capacity_score": fmt_num(data.get("copy_capacity_score")),
        "alert_grade": data.get("alert_grade") or "none",
        "auto_action": data.get("auto_action") or "store_only",
        "score_flags_bullets": bullets(data.get("score_flags") or []),
